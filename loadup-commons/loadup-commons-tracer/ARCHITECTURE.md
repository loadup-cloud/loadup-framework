# loadup-commons-tracer — Architecture

## 1. 概览

`loadup-commons-tracer` 是 LoadUp 框架的系统级链路追踪组件，基于 **OpenTelemetry SDK 1.62**
...
```
loadup-commons-tracer/src/main/java/.../tracer/
├── autoconfigure/
...
**SPI 注册文件**：  
`src/main/resources/META-INF/services/io.github.loadup.common.tracer.spi.SpanExporterProvider`
