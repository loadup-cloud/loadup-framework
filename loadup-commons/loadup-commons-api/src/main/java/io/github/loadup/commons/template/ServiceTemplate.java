// package io.github.loadup.commons.template;
//
/// *-
// * #%L
// * loadup-commons-dto
...
// */
//
// import io.github.loadup.commons.error.AssertUtil;
...
//      response =
//          composeExceptionResponse.apply(Result.buildFailure(exception.getResultCode())); // 异常处理
//    } catch (Exception throwable) {
//      log.error("service process,  exception occurred:{}", throwable.getMessage());
//      response =
//          composeExceptionResponse.apply(Result.buildFailure(CommonResultCodeEnum.UNKNOWN)); //
// 异常处理
