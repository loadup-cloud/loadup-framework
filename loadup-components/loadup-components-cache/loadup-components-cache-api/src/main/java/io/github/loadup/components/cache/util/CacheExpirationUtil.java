// package io.github.loadup.components.cache.util;
//
/// *-
// * #%L
...
// */
//
// import io.github.loadup.components.cache.cfg.CacheConfigs;
...
//
//  /**
//   * Calculate expiration duration with percentage-based random offset This is more flexible for
//   * different base durations
//   *
//   * @param baseDuration Base expiration duration
//   * @param offsetPercentage Random offset percentage (0.0 to 1.0)
//   * @return Duration with random offset
//   */
//  public static Duration calculateExpirationWithPercentageOffset(
//      Duration baseDuration, double offsetPercentage) {
//    long baseSeconds = baseDuration.getSeconds();
...
//
//  /**
//   * Parse duration string to Duration object Supports format: "30s", "5m", "1h", "2d"
//   *
...
//
//  /**
//   * Calculate staggered expiration times for batch cache loading Useful for cache warming
// scenarios
//   *
//   * @param baseDuration Base expiration duration
...
//   */
//  public static Duration calculateStaggeredExpiration(
//      Duration baseDuration, int index, int batchSize, Duration staggerWindow) {
//    if (batchSize <= 1) {
//      return baseDuration;
//    }
//
