...
public class CaffeineConcurrencyTest extends BaseCacheTest {
    ...
    void testConcurrentWrites() throws InterruptedException {
        ...
        // Then
        assertEquals(threadCount * operationsPerThread, successCount.get(), "All concurrent writes should succeed");
    ...
    void testConcurrentReads() throws InterruptedException {
        ...
        // Then
        assertEquals(threadCount * readsPerThread, successCount.get(), "All concurrent reads should succeed");
    }
