...
ALTER TABLE sys_user
    ADD COLUMN created_at DATETIME                              NOT NULL COMMENT '创建时间',
    ADD COLUMN updated_at DATETIME  ON UPDATE CURRENT_TIMESTAMP NOT NULL COMMENT '更新时间';
...
(
    ...
    updated_at             DATETIME  ON UPDATE CURRENT_TIMESTAMP NOT NULL COMMENT '更新时间',
    INDEX idx_code (code),
