package com.github.loadup.components.scheduler.powerjob;
...
public class PowerJobSchedulerProvider implements SchedulerProvider {
    private final ConcurrentHashMap<String, SchedulerTask> jobs = new ConcurrentHashMap<>();

    public PowerJobSchedulerProvider(PowerJobSchedulerConfig config) {}
