...
import io.github.loadup.components.tracer.*;
...
@TestPropertySource(
    properties = {"spring.application.name=concurrent-test-service", "loadup.tracer.enabled=true"})
class ConcurrentTracingTest {
  ...
  @Test
  void testTraceContextThreadIsolation()
