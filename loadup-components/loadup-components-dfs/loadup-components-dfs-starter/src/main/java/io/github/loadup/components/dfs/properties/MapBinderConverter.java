...
public class MapBinderConverter extends JsonDeserializer<Map<BinderType, BinderConfig>> {
    ...
    @Override
    public Map<BinderType, BinderConfig> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        node.fields().forEachRemaining(entry -> {
            try {
                ...
                throw new RuntimeException("Failed to deserialize binder config for key: " + entry.getKey(), e);
            }
        });
