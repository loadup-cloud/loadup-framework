 ...
 *
 * <p>This initializer configures Spring Boot test context to use the shared PostgreSQL container.
 * It automatically sets the necessary database connection properties.
 *
