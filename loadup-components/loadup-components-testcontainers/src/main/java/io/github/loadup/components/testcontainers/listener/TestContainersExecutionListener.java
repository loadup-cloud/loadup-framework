...
public class TestContainersExecutionListener extends AbstractTestExecutionListener {
    ...
    public void beforeTestClass(TestContext testContext) throws Exception {
        ...
        log.info(">>> [TESTCONTAINERS] ========== Initialization Complete ==========");
    }
