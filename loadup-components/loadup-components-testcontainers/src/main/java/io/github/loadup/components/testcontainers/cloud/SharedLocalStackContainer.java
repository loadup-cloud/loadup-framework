...
public final class SharedLocalStackContainer {
     ...
     */
    private static String secretKey = "test";
    ...
    public static void startContainer(TestContainersProperties.ContainerConfig config) {
        ...
        synchronized (SharedLocalStackContainer.class) {
            ...
            localstackContainer = new LocalStackContainer(DockerImageName.parse(image)).withReuse(true);

            localstackContainer.start();
            STARTED.set(true);

            s3Endpoint = localstackContainer.getEndpoint().toString();
