...
public class GotoneAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public NotificationService notificationService(NotificationServiceRepository serviceRepository, ServiceChannelRepository channelRepository, NotificationChannelManager channelManager,
                                                   NotificationRecordRepository notificationRecordRepository, TemplateProcessor templateProcessor) {
        log.info(">>> [GOTONE] NotificationService initialized");
        return new NotificationServiceImpl(serviceRepository, channelRepository, notificationRecordRepository, channelManager, templateProcessor);
    }
}
