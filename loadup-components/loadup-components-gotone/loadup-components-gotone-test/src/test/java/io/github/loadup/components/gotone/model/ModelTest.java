...
class ModelTest {
  ...
  void testNotificationRequestMultipleReceivers() {
    ...
    assertThat(request.getReceivers())
  ...
  void testNotificationRequestTemplateParams() {
    ...
    // When
    NotificationRequest request = NotificationRequest.builder().templateParams(params).build();
  ...
  void testNotificationRequestToString() {
    // Given
    NotificationRequest request =
        NotificationRequest.builder().bizId("test-001").channel(NotificationChannel.SMS).build();
