...
class GotoneConverterTest {
  ...
  private GotoneConverter converter;
  ...
  void testToChannelMapping() {
    ...
    channelMappingDO.setBusinessCode("ORDER_CONFIRM");
    channelMappingDO.setChannel("SMS");
    channelMappingDO.setTemplateCode("ORDER_CONFIRM_SMS");
    channelMappingDO.setProviderListJson("[\"aliyun\",\"tencent\"]");
    channelMappingDO.setPriority(10);
    channelMappingDO.setEnabled(true);
  ...
  void testToChannelMappingWithNullProviderList() {
    ...
    ChannelMappingDO channelMappingDO = new ChannelMappingDO();
    channelMappingDO.setId("1");
    channelMappingDO.setBusinessCode("TEST");
    channelMappingDO.setChannel("EMAIL");
    channelMappingDO.setProviderListJson(null);
  ...
  void testToChannelMappingDO() {
    ...
    assertThat(result.getId()).isEqualTo("1");
    assertThat(result.getBusinessCode()).isEqualTo("ORDER_CONFIRM");
    assertThat(result.getProviderListJson()).contains("aliyun", "tencent");
  }
  ...
  void testToChannelMappingList() {
    ...
    do1.setId("1");
    do1.setBusinessCode("TEST");
    do1.setChannel("SMS");
    do1.setProviderListJson("[\"aliyun\"]");

    ChannelMappingDO do2 = new ChannelMappingDO();
    do2.setId("2");
    do2.setBusinessCode("TEST");
    do2.setChannel("EMAIL");
    do2.setProviderListJson("[\"smtp\"]");
  ...
  void testToNotificationRecord() {
    ...
    recordDO.setBusinessCode("ORDER_CONFIRM");
    recordDO.setBizId("biz-001");
    recordDO.setMessageId("msg-001");
    recordDO.setChannel("SMS");
    recordDO.setReceiversJson("[\"13800138000\",\"13900139000\"]");
    recordDO.setTemplateCode("ORDER_CONFIRM_SMS");
    recordDO.setTitle("订单确认");
    recordDO.setContent("您的订单已确认");
  ...
  void testToNotificationRecordWithNullReceivers() {
    ...
    recordDO.setId("1");
    recordDO.setBizId("biz-001");
    recordDO.setReceiversJson(null);
  ...
  void testToNotificationRecordDO() {
    ...
    record.setReceivers(Arrays.asList("13800138000", "13900139000"));
    ...
    assertThat(result).isNotNull();
    assertThat(result.getId()).isEqualTo("1");
    assertThat(result.getReceiversJson()).contains("13800138000", "13900139000");
  }
  ...
  void testToNotificationRecordList() {
    ...
    do1.setId("1");
    do1.setBizId("biz-1");
    do1.setReceiversJson("[\"user1\"]");

    NotificationRecordDO do2 = new NotificationRecordDO();
    do2.setId("2");
    do2.setBizId("biz-2");
    do2.setReceiversJson("[\"user2\"]");
  ...
  void testJsonConversionWithInvalidJson() {
    ...
    ChannelMappingDO channelMappingDO = new ChannelMappingDO();
    channelMappingDO.setId("1");
    channelMappingDO.setProviderListJson("invalid-json");
