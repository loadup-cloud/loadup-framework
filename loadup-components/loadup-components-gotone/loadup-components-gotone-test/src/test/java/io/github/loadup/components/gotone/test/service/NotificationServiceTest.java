...
public class NotificationServiceTest extends GotoneTestBase {
    ...
    public void testSendNotification_Success(NotificationRequest request) {

        runTest(() -> notificationService.send(request));
    }

    @Test(dataProvider = "testifyData")
    public void testSendNotification_WithIdempotence(NotificationRequest request) {
    ...
    @Test(dataProvider = "testifyData")
    public void testSendNotification_WithSpecifiedChannels(NotificationRequest request) {
