...
public class JwtTokenProvider {
    ...
    @Value("${upms.security.jwt.secret:LoadUpFrameworkSecretKeyForJWTTokenGenerationMustBeLongEnough}")
    ...
    public SecurityUser parseToken(String token) {
        try {
            ...
            Set<String> permissions = new HashSet<>(rawAuths != null ? rawAuths : Collections.emptyList());
