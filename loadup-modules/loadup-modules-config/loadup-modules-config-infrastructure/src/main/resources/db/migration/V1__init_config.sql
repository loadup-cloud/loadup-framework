...
(
    ...
    system_defined BOOLEAN      NOT NULL DEFAULT FALSE COMMENT '是否系统内置（不可删除）',
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT ='系统参数配置表';
...
(
    ...
    description    VARCHAR(500) COMMENT '描述',
    system_defined BOOLEAN      NOT NULL DEFAULT FALSE COMMENT '是否系统内置',
    sort_order     INT          NOT NULL DEFAULT 0 COMMENT '排序',
    enabled        BOOLEAN      NOT NULL DEFAULT TRUE COMMENT '是否启用',
    created_by     VARCHAR(64) COMMENT '创建人',
    created_at     DATETIME     NOT NULL  COMMENT '创建时间',
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='数据字典项表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='配置变更历史表';
