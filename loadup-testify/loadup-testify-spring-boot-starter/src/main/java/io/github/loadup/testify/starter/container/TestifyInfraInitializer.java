...
@Slf4j
public class TestifyInfraInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext context) {
        ...
        if (Boolean.TRUE.equals(enabled)) {
            ...
            if (!infraProps.isEmpty()) {
                ...
                env.getPropertySources().addFirst(new MapPropertySource("testifyInfraProps", (Map) infraProps));
            }
        }
    }
