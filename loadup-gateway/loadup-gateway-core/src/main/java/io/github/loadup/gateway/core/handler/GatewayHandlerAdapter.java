...
public class GatewayHandlerAdapter implements HandlerAdapter, Ordered {
    ...
    public ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // Propagate pre-resolved RouteConfig from GatewayHandler to context,
        // avoiding a redundant second route lookup in RouteAction
        if (gatewayHandler.getRouteConfig() != null) {
            context.setRoute(gatewayHandler.getRouteConfig());
        }
    ...
    private GatewayContext buildGatewayContext(
        HttpServletRequest request, HttpServletResponse response, GatewayHandler handler) throws IOException {
    ...
    private GatewayRequest buildGatewayRequest(HttpServletRequest request) throws IOException {
        ...
        return GatewayRequest.builder()
            .requestId(TraceUtil.getTracerId())
     ...
     */
    private void writeResponse(HttpServletResponse response, GatewayResponse gatewayResponse) throws IOException {
