...
public class TemplateEngine {
     ...
     * Uses the script text directly as the cache key to avoid hashCode collisions
     * where different scripts could map to the same bucket.
     */
    private groovy.lang.Script getCompiledScript(String scriptText) {
        return scriptCache.computeIfAbsent(scriptText, k -> groovyShell.parse(scriptText));
    }
