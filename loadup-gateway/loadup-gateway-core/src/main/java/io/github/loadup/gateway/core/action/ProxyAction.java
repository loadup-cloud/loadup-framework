...
public class ProxyAction implements GatewayAction {
    ...
    public void execute(GatewayContext context, GatewayActionChain chain) {
        try {
            ...
            // Preserve the original exception type so ExceptionAction can extract ErrorCode / ErrorType.
            // If it's already a GatewayException or RuntimeException, rethrow it directly.
