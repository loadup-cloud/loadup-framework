package io.github.loadup.components.tracer.metrics;
...
@ConditionalOnProperty(prefix = "loadup.tracer", name = "metrics-enabled", havingValue = "true", matchIfMissing = true)
public class MetricsConfig {
    ...
    public MeterRegistryCustomizer<MeterRegistry> metricsCommonTags(
        ...
        return registry -> registry.config().commonTags("application", applicationName, "framework", "loadup");
    }
