 ...
 * 优化：支持自定义字符集，移除容易混淆的字符（0, O, 1, I, L, i, l）
 */
public class Randoms {
	...
	public static final char DEFAULT_ALPHA[] = {
		'2', '3', '4', '5', '6', '7', '8', '9',  // 数字：去除了 0 和 1
		'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z',  // 大写字母：去除了 I, L, O
		'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'   // 小写字母：去除了 i, l, o
	};
