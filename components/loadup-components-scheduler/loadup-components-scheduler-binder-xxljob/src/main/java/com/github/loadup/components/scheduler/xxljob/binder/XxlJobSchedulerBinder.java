...
/**
 * XXL-Job scheduler binder implementation. Note: XXL-Job uses annotation-based task registration
 * (@XxlJob), so this binder provides limited runtime management capabilities.
 */
@Slf4j
