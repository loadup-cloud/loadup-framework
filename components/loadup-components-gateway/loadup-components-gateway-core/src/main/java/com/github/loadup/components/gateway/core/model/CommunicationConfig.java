...
public class CommunicationConfig {
    ...
    private static final LinkedHashSet<ErrorCode> gatewayliteErrorCode = new LinkedHashSet<>();

    static {
        Collections.addAll(gatewayliteErrorCode, CertificationErrorCode.values());
        Collections.addAll(gatewayliteErrorCode, ParserErrorCode.values());
        Collections.addAll(gatewayliteErrorCode, CommunicationErrorCode.values());
        Collections.addAll(gatewayliteErrorCode, OauthErrorCode.values());
        Collections.addAll(gatewayliteErrorCode, LimitRuleErrorCode.values());
        Collections.addAll(gatewayliteErrorCode, GatewayliteErrorCode.values());
    }
     ...
     */
    private Map<Integer, ErrorCode> errorCodeMap = new HashMap<>();
     ...
     */
    public Map<Integer, ErrorCode> getErrorCodeMap() {
        return errorCodeMap;
    }
     ...
     */
    public void setErrorCodeMap(Map<Integer, ErrorCode> errorCodeMap) {
     ...
     */
    public ErrorCode getHttpStatusErrorCode(int httpStatus) {
    ...
    public void setErrorCodeMap(String errorCodeMapString) {
        ...
        for (String config : configs) {
            ...
            for (ErrorCode errorCode : gatewayliteErrorCode) {
