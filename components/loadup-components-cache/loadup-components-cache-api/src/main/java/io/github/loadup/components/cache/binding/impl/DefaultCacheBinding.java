package io.github.loadup.components.cache.binding.impl;
...
@Slf4j
public class DefaultCacheBinding extends AbstractBinding<CacheBinder<?, CacheBindingCfg>, CacheBindingCfg>
