...
//  @ConditionalOnProperty(prefix = "loadup.cache", name = "binder", havingValue = "caffeine")
//  public CacheManager defaultCacheManager(CaffeineCacheBinderCfg caffeineCacheBinderCfg) {
...
//        caffeineCacheBinderCfg.hasCustomConfig() ? caffeineCacheBinderCfg.getSpec() : springCacheSpec;
//
//    if (effectiveSpec != null && !effectiveSpec.isEmpty()) {
//      cacheManager.setCacheSpecification(effectiveSpec);
//      if (caffeineCacheBinderCfg.hasCustomConfig()) {
//        log.info(
