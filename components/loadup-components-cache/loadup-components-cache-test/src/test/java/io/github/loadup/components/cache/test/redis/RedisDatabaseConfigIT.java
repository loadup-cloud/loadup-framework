...
public class RedisDatabaseConfigIT extends BaseRedisCacheTest {
    ...
    void testRedisConnectionFactoryUsesCustomDatabase() {
        ...
        assertInstanceOf(LettuceConnectionFactory.class, redisConnectionFactory, "Should be LettuceConnectionFactory");
    ...
    void testDatabaseIsolation() {
        ...
        LettuceConnectionFactory db0Factory = new LettuceConnectionFactory(
                new RedisStandaloneConfiguration(SharedRedisContainer.getHost(), SharedRedisContainer.getPort()));
