...
@TestPropertySource(
    properties = {
      ...
      "loadup.cache.redis.cache-config.hot-data.random-offset-seconds=2",
      "loadup.cache.redis.cache-config.hot-data.priority=9",
      "loadup.cache.redis.cache-config.normal-data.expire-after-write=3s",
      "loadup.cache.redis.cache-config.normal-data.maximum-size=100",
      "loadup.cache.redis.cache-config.normal-data.enable-random-expiration=true",
      "loadup.cache.redis.cache-config.normal-data.random-offset-seconds=1"
    })
