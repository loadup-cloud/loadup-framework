...
public class AliyunSmsProvider implements NotificationChannelProvider {
    ...
    public ChannelSendResponse send(ChannelSendRequest request) {
        log.info(
                ">>> [GOTONE-SMS-ALIYUN] 开始发送短信, receivers={}, content length={}",
    ...
    public boolean isAvailable() {
        boolean available = accessKeyId != null
    ...
    private boolean mockAliyunSmsApi(
            String phoneNumber, String signName, String templateCode, ChannelSendRequest request) {
        // TODO: 实际集成时替换为真实的阿里云SDK调用
        log.debug(
                ">>> [GOTONE-SMS-ALIYUN] Mock API Call: phone={}, sign={}, template={}",
