package com.github.loadup.components.gotone.repository;
...
public class RepositoryIntegrationTest extends AbstractMySQLContainerTest {
    ...
    void testBusinessCodeRepositoryFindByCode() {
        // When
        Optional<BusinessCodeDO> result = businessCodeRepository.findByBusinessCodeAndEnabled("ORDER_CONFIRM");
    ...
    void testBusinessCodeRepositoryFindByCodeNotFound() {
        // When
        Optional<BusinessCodeDO> result = businessCodeRepository.findByBusinessCodeAndEnabled("NOT_EXIST");
    ...
    void testBusinessCodeRepositorySave() {
        ...
        // Verify
        Optional<BusinessCodeDO> found = businessCodeRepository.findByBusinessCodeAndEnabled("NEW_CODE");
    ...
    void testChannelMappingRepositoryFindByBusinessCode() {
        // When
        List<ChannelMappingDO> results = channelMappingRepository.findByBusinessCodeAndEnabled("ORDER_CONFIRM");
    ...
    void testChannelMappingRepositoryFindByBusinessCodeAndChannel() {
        // When
        Optional<ChannelMappingDO> result = channelMappingRepository.findByBusinessCodeAndChannelAndEnabled("ORDER_CONFIRM", "SMS");
    ...
    void testNotificationTemplateRepositoryFindByCode() {
        // When
        Optional<NotificationTemplateDO> result = templateRepository.findByTemplateCodeAndEnabled("ORDER_CONFIRM_SMS");
    ...
    void testNotificationRecordRepositoryFindByBusinessCodeAndStatus() {
        ...
        // When
        List<NotificationRecordDO> results = recordRepository.findByBusinessCodeAndStatus("PAYMENT_SUCCESS", "FAILED");

        // Then
        assertThat(results).isNotEmpty();
        assertThat(results).allMatch(r -> r.getBusinessCode().equals("PAYMENT_SUCCESS") && r.getStatus().equals("FAILED"));
    }
