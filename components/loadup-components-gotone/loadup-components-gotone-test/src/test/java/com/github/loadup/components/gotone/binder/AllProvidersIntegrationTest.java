package com.github.loadup.components.gotone.binder;
...
import com.github.loadup.components.gotone.binder.sms.*;
...
class AllProvidersIntegrationTest {
    ...
    @ParameterizedTest
    @MethodSource("provideAllProviders")
    void testAllProvidersReturnCorrectProviderName(INotificationProvider provider, String expectedName, String channel) {
        // When & Then
    ...
    @ParameterizedTest
    @MethodSource("provideAllProviders")
    void testAllProvidersAreAvailableWithValidConfig(INotificationProvider provider, String providerName, String channel) {
        // When & Then
    ...
    void testProvidersByChannel() {
        ...
        INotificationProvider[] emailProviders = {
            new SmtpEmailProvider()
        };

        INotificationProvider[] pushProviders = {
            new FcmPushProvider()
        };
