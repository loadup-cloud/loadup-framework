...
-- 1. 创建服务：订单创建通知
INSERT INTO gotone_notification_service (id, service_code, service_name, description, enabled, priority, created_at, updated_at)
...
INSERT INTO gotone_service_channel (
    ...
    '{"subject": "订单创建通知", "from": "order@loadup.com"}',
    'smtp',
    NULL,
    'ASYNC',
...
INSERT INTO gotone_service_channel (
    ...
    '{"signName": "LoadUp", "templateId": "SMS_VERIFY"}',
    'aliyun',
    '["yunpian", "tencent"]',
    'SYNC',
