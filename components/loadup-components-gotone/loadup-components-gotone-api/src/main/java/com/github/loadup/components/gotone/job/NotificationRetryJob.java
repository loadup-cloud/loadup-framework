package com.github.loadup.components.gotone.job;
 ...
 * 可集成 LoadUp Scheduler 组件实现更复杂的调度策略
 */
@Slf4j
@Component
public class NotificationRetryJob {
    ...
    private void retryRecord(NotificationRecord record) {
        log.info("Retrying notification: bizId={}, retryCount={}",
            record.getBizId(), record.getRetryCount());
