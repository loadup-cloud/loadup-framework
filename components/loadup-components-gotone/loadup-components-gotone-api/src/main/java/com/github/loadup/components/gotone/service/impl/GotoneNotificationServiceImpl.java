package com.github.loadup.components.gotone.service.impl;
...
import com.github.loadup.components.gotone.converter.GotoneConverter;
import com.github.loadup.components.gotone.dataobject.ChannelMappingDO;
import com.github.loadup.components.gotone.dataobject.NotificationTemplateDO;
...
import com.github.loadup.components.gotone.repository.*;
...
public class GotoneNotificationServiceImpl implements GotoneNotificationService {
     ...
     * 发送单个渠道
     */
    private boolean sendChannel(ChannelMapping mapping, String bizId, List<String> addresses, Map<String, Object> params) {
        ...
        String title = templateDO.getTitleTemplate() != null
     ...
     * 构建失败响应
     */
    private NotificationResponse buildFailedResponse(NotificationRequest request, String provider, String errorMessage) {
