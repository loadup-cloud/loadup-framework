package com.github.loadup.modules.upms.test.userservice.getuserbypostids;
 ...
 *
 * @author ACTS
 * @version $Id: GetUserByPostIdsActsTest.java, v1.0.0 2025-04-23 16:40:27 ACTS Exp $
 */
public class GetUserByPostIdsTest extends LoadupUpmsTestBase {
	 ...
	 *
	 * {@link com.github.loadup.modules.upms.client.api.UserService#getUserByPostIds(com.github.loadup.modules.upms.client.query.UserPostListQuery)}
	 **/
	@Test(dataProvider = "ActsDataProvider")
	@AutoFill(overwrite = false, sqlList = {})
    @RunOnly(caseList = {".*"})  // 支持正则匹配，且仅在本地调试时生效
	public void getUserByPostIds(String caseId, String desc, PrepareData prepareData) {
