package com.github.loadup.modules.upms.test.userservice.unlockuser;
 ...
 *
 * @author ACTS
 * @version $Id: UnLockUserActsTest.java, v1.0.0 2025-04-23 16:40:27 ACTS Exp $
 */
public class UnLockUserTest extends LoadupUpmsTestBase {
	 ...
	 *
	 * {@link com.github.loadup.modules.upms.client.api.UserService#unLockUser(com.github.loadup.modules.upms.client.cmd.UserStatusUpdateCmd)}
	 **/
	@Test(dataProvider = "ActsDataProvider")
	@AutoFill(overwrite = false, sqlList = {})
    @RunOnly(caseList = {".*"})  // 支持正则匹配，且仅在本地调试时生效
	public void unLockUser(String caseId, String desc, PrepareData prepareData) {
