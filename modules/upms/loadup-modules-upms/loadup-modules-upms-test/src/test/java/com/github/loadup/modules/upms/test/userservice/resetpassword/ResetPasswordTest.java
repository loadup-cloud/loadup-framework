package com.github.loadup.modules.upms.test.userservice.resetpassword;
 ...
 *
 * @author ACTS
 * @version $Id: ResetPasswordActsTest.java, v1.0.0 2025-04-23 16:40:27 ACTS Exp $
 */
public class ResetPasswordTest extends LoadupUpmsTestBase {
	 ...
	 *
	 * {@link com.github.loadup.modules.upms.client.api.UserService#resetPassword(com.github.loadup.modules.upms.client.cmd.UserResetPasswordCmd)}
	 **/
	@Test(dataProvider = "ActsDataProvider")
	@AutoFill(overwrite = false, sqlList = {})
    @RunOnly(caseList = {".*"})  // 支持正则匹配，且仅在本地调试时生效
	public void resetPassword(String caseId, String desc, PrepareData prepareData) {
