package com.github.loadup.modules.upms.test.userservice.lockuser;
 ...
 *
 * @author ACTS
 * @version $Id: LockUserActsTest.java, v1.0.0 2025-04-23 16:40:27 ACTS Exp $
 */
public class LockUserTest extends LoadupUpmsTestBase {
	 ...
	 *
	 * {@link com.github.loadup.modules.upms.client.api.UserService#lockUser(com.github.loadup.modules.upms.client.cmd.UserStatusUpdateCmd)}
	 **/
	@Test(dataProvider = "ActsDataProvider")
	@AutoFill(overwrite = false, sqlList = {})
    @RunOnly(caseList = {".*"})  // 支持正则匹配，且仅在本地调试时生效
	public void lockUser(String caseId, String desc, PrepareData prepareData) {
