package com.github.loadup.modules.upms.test.userservice.changepassword;
 ...
 *
 * @author ACTS
 * @version $Id: ChangePasswordActsTest.java, v1.0.0 2025-04-23 16:40:27 ACTS Exp $
 */
public class ChangePasswordTest extends LoadupUpmsTestBase {
	 ...
	 *
	 * {@link com.github.loadup.modules.upms.client.api.UserService#changePassword(com.github.loadup.modules.upms.client.cmd.UserChangePasswordCmd)}
	 **/
	@Test(dataProvider = "ActsDataProvider")
	@AutoFill(overwrite = false, sqlList = {})
    @RunOnly(caseList = {".*"})  // 支持正则匹配，且仅在本地调试时生效
	public void changePassword(String caseId, String desc, PrepareData prepareData) {
