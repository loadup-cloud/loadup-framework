...
import com.alipay.test.acts.util.ActsCommonUtil;
 ...
 *
 * @author pumo
 * @version $Id: ActsMenu.java, v 0.1 2021年01月13日 下午5:46 pumo Exp $
 */
public class ActsMenu {
    /*** 此处替换成自己的应用名 ***/
     ...
     */
    @Test
    public void initActs() throws Exception {
        // 生成接口下所有方法的测试脚本
        ActsCommonUtil.initActs(appName, "upms",true);
    }
    ...
    public void genScript() throws Exception {
        // 方式一：生成接口下所有方法的测试脚本
        ActsCommonUtil.genTestScript(UserService.class, appName,"upms");
    ...
    public void genObjYaml() {
        ...
        ActsCommonUtil.genObjToYamlStr(list);
    }
    ...
    public void genDBModel() throws Exception {
        ...
        ActsCommonUtil.genDBTableCols(gs);
    }
}
