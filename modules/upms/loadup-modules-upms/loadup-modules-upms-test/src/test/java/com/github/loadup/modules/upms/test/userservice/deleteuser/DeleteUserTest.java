package com.github.loadup.modules.upms.test.userservice.deleteuser;
 ...
 *
 * @author ACTS
 * @version $Id: DeleteUserActsTest.java, v1.0.0 2025-04-23 16:40:27 ACTS Exp $
 */
public class DeleteUserTest extends LoadupUpmsTestBase {
	 ...
	 *
	 * {@link com.github.loadup.modules.upms.client.api.UserService#deleteUser(com.github.loadup.modules.upms.client.cmd.UserDeleteCmd)}
	 **/
	@Test(dataProvider = "ActsDataProvider")
	@AutoFill(overwrite = false, sqlList = {})
    @RunOnly(caseList = {".*"})  // 支持正则匹配，且仅在本地调试时生效
	public void deleteUser(String caseId, String desc, PrepareData prepareData) {
