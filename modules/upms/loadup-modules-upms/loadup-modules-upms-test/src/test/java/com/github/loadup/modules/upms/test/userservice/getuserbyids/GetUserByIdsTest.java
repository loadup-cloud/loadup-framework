package com.github.loadup.modules.upms.test.userservice.getuserbyids;
 ...
 *
 * @author ACTS
 * @version $Id: GetUserByIdsActsTest.java, v1.0.0 2025-04-23 16:40:27 ACTS Exp $
 */
public class GetUserByIdsTest extends LoadupUpmsTestBase {
	 ...
	 *
	 * {@link com.github.loadup.modules.upms.client.api.UserService#getUserByIds(com.github.loadup.commons.request.query.IdListQuery)}
	 **/
	@Test(dataProvider = "ActsDataProvider")
	@AutoFill(overwrite = false, sqlList = {})
    @RunOnly(caseList = {".*"})  // 支持正则匹配，且仅在本地调试时生效
	public void getUserByIds(String caseId, String desc, PrepareData prepareData) {
