...
-- Insert test users
INSERT INTO upms_user (id, username, password, nickname, email, phone, status, dept_id, deleted, tenant_id, created_by, created_at)
...
-- Insert test roles
INSERT INTO upms_role (id, role_name, role_code, role_level, data_scope, status, deleted, tenant_id, created_by, created_at)
...
INSERT INTO upms_user_role (id, user_id, role_id, tenant_id, created_by, created_at)
VALUES ('1', '1', '1', '1', '1', CURRENT_TIMESTAMP),
       ('2', '2', '3', '1', '1', CURRENT_TIMESTAMP),
       ('3', '3', '3', '1', '1', CURRENT_TIMESTAMP);

-- Insert role-permission relations
INSERT INTO upms_role_permission (id, role_id, permission_id, tenant_id, created_by, created_at)
VALUES ('1', '1', '1', '1', '1', CURRENT_TIMESTAMP),
