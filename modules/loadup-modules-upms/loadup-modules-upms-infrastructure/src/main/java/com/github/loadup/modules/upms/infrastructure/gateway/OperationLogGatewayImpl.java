package com.github.loadup.modules.upms.infrastructure.gateway;
...
import static com.github.loadup.modules.upms.infrastructure.dataobject.table.Tables.OPERATION_LOG_DO;
...
public class OperationLogGatewayImpl implements OperationLogGateway {
  ...
  @Override
  public org.springframework.data.domain.Page<OperationLog> findByUserId(
