...
import com.github.loadup.commons.error.AssertionCallback;
...
public class AssertUtil {
  ...
  public static void contains(
      Object base, Collection<?> collection, ResultCode resultCode, Object... objs) {
  ...
  public static void notIn(
      Object base, Object[] collection, ResultCode resultCode, Object... objs) {
    if (null != collection) {
  ...
  public static void deductNotBlank(
      boolean condition, String str, ResultCode resultCode, Object... objs) {
    if (condition) {
      notBlank(str, resultCode, objs);
    }
  }

  public static void deductBlank(
      boolean condition, String str, ResultCode resultCode, Object... objs) {
    if (condition) {
  ...
  public static void deductTrue(
      boolean condition, boolean expValue, ResultCode resultCode, Object... objs) {
    if (condition) {
      isTrue(expValue, resultCode, objs);
    }
  }
  ...
  public static <X extends Throwable> void isTrue(
      final boolean expression, final Supplier<? extends X> supplier) throws X {
    if (!expression) {
      throw supplier.get();
    }
  }
  ...
  public static void isTrue(
      final boolean expression, final String errorMsgTemplate, final Object... params)
   ...
   * @since 5.4.5
   */
  public static <X extends Throwable> void isFalse(
      final boolean expression, final Supplier<X> errorSupplier) throws X {
    if (expression) {
   ...
   * @since 5.4.5
   */
  public static <X extends Throwable> void isNull(
      final Object object, final Supplier<X> errorSupplier) throws X {
    if (null != object) {
      throw errorSupplier.get();
    }
  }
  ...
  public static void isNull(
      final Object object, final String errorMsgTemplate, final Object... params)
      throws IllegalArgumentException {
    isNull(
        object, () -> new IllegalArgumentException(StringUtils.format(errorMsgTemplate, params)));
  }
   ...
   * @since 5.4.5
   */
  public static <T, X extends Throwable> T notNull(final T object, final Supplier<X> errorSupplier)
      throws X {
    if (null == object) {
      throw errorSupplier.get();
    }
  ...
  public static <T extends CharSequence> T notEmpty(
      final T text, final String errorMsgTemplate, final Object... params)
      throws IllegalArgumentException {
    return notEmpty(
        text, () -> new IllegalArgumentException(StringUtils.format(errorMsgTemplate, params)));
  }
  ...
  public static <T extends CharSequence> T notEmpty(final T text) throws IllegalArgumentException {
    return notEmpty(
        text,
        "[Assertion failed] - this String argument must have length; it must not be null or"
            + " empty");
  }
  ...
  public static <T extends CharSequence> T notBlank(final T text) throws IllegalArgumentException {
    return notBlank(
        text,
        "[Assertion failed] - this String argument must have text; it must not be null,"
            + " empty, or blank");
  }
  ...
  public static <T extends CharSequence, X extends Throwable> T notContain(
      final CharSequence textToSearch, final T substring, final Supplier<X> errorSupplier)
      throws X {
   ...
   * @throws IllegalArgumentException 非子串抛出异常
   */
  public static String notContain(final String textToSearch, final String subString)
      throws IllegalArgumentException {
    return notContain(
        textToSearch,
        subString,
   ...
   * @since 5.4.5
   */
  public static <T, X extends Throwable> T[] notEmpty(
      final T[] array, final Supplier<X> errorSupplier) throws X {
  ...
  public static <T> T[] notEmpty(
      final T[] array, final String errorMsgTemplate, final Object... params)
      throws IllegalArgumentException {
    return notEmpty(
        array, () -> new IllegalArgumentException(StringUtils.format(errorMsgTemplate, params)));
  }
  ...
  public static <T> T[] notEmpty(final T[] array) throws IllegalArgumentException {
    return notEmpty(
        array,
        "[Assertion failed] - this array must not be empty: it must contain at least 1"
            + " element");
  }
   ...
   * @since 5.4.5
   */
  public static <T, X extends Throwable> T[] noNullElements(
      final T[] array, final Supplier<X> errorSupplier) throws X {
  ...
  public static <E, T extends Iterable<E>> T notEmpty(
      final T collection, final String errorMsgTemplate, final Object... params)
      throws IllegalArgumentException {
    return notEmpty(
        collection,
        () -> new IllegalArgumentException(StringUtils.format(errorMsgTemplate, params)));
   ...
   * @throws IllegalArgumentException if the collection is {@code null} or has no elements
   */
  public static <E, T extends Iterable<E>> T notEmpty(final T collection)
      throws IllegalArgumentException {
    return notEmpty(
        collection,
        "[Assertion failed] - this collection must not be empty: it must contain at least 1"
            + " element");
  }
  ...
  public static <K, V, T extends Map<K, V>> T notEmpty(
      final T map, final String errorMsgTemplate, final Object... params)
      throws IllegalArgumentException {
    return notEmpty(
        map, () -> new IllegalArgumentException(StringUtils.format(errorMsgTemplate, params)));
  }
  ...
  public static int checkIndex(
      final int index, final int size, final String errorMsgTemplate, final Object... params)
      throws IllegalArgumentException, IndexOutOfBoundsException {
  ...
  public static <X extends Throwable> int checkBetween(
      final int value, final int min, final int max, final Supplier<? extends X> errorSupplier)
      throws X {
  ...
  public static <X extends Throwable> long checkBetween(
      final long value, final long min, final long max, final Supplier<? extends X> errorSupplier)
      throws X {
    if (value < min || value > max) {
      throw errorSupplier.get();
    }
  ...
  public static <X extends Throwable> double checkBetween(
      ...
      final double min,
      final double max,
      final Supplier<? extends X> errorSupplier)
      throws X {
    if (value < min || value > max) {
      throw errorSupplier.get();
    }
  ...
  public static Number checkBetween(final Number value, final Number min, final Number max) {
    ...
    if (valueDouble < minDouble || valueDouble > maxDouble) {
      throw new IllegalArgumentException(
          StringUtils.format(TEMPLATE_VALUE_MUST_BE_BETWEEN_AND, min, max));
    }
    return value;
  }
  ...
  /** 错误的下标时显示的消息 */
  private static String badIndexMsg(
      final int index, final int size, final String desc, final Object... params) {
    if (index < 0) {
      return StringUtils.format(
          "{} ({}) must not be negative", StringUtils.format(desc, params), index);
    } else if (size < 0) {
