...
public class BindingContext<B extends Binder, C extends BaseBindingCfg> {
    ...
    public BindingContext(
            String bizTag, String binderType, C bindingCfg, List<B> binders, ApplicationContext applicationContext) {
        this.bizTag = bizTag;
        this.binderType = binderType;
        this.bindingCfg = bindingCfg;
        this.binders = binders != null ? Collections.unmodifiableList(binders) : Collections.emptyList();
